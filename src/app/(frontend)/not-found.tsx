  ...
  return (
    <div className="bg-ink px-5 pb-32 pt-44 sm:px-10 lg:px-16">
      <div className="mx-auto w-full max-w-[90rem]">
        <p className="mb-5 font-display text-8xl font-extrabold leading-[0.85] text-accent">404</p>
        ...
        <div className="flex flex-wrap gap-3.5">
          ...
          <Link
            href="/#upcoming"
            className="inline-flex min-h-[3.25rem] items-center border border-white/30 px-7 font-display text-[13px] font-semibold uppercase tracking-[0.16em] text-white no-underline transition-colors hover:border-accent"
          >
            See dates
          </Link>
        </div>
